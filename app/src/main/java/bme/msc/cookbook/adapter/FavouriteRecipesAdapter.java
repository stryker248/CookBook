...
public class FavouriteRecipesAdapter extends RecyclerView.Adapter<FavouriteRecipesAdapter.ViewHolder> {
    ...
    public FavouriteRecipesAdapter(Context context, List<FavouriteRecipe> recipesList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        FavouriteRecipe recipe = recipesList.get(position);
    ...
    protected static class ViewHolder extends RecyclerView.ViewHolder
        ...
        private void showPopupMenu(View v) {
            ...
            popupMenu.inflate(R.menu.card_recipe_favourite_menu);
            popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                @Override
                public boolean onMenuItemClick(MenuItem item) {
                    RemoveRecipeFromFavouritesEvent event = new RemoveRecipeFromFavouritesEvent();
                    event.setId(Long.parseLong(tvId.getText().toString()));
